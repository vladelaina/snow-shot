...
// import { EnableStraightLinePicker } from '../pickers/enableStraightLine';
...
//     const enableStraightLineRef = useRef<EnableStraightLineValue>(defaultEnableStraightLineValue);
...
//                 'multiply',
//             );
//             canvasDrawRef.current.start(mousePosition, enableStraightLineRef.current.enable);
//         },
...
//         canvasDrawRef.current.execute(mousePosition, enableStraightLineRef.current.enable);
//     }, []);
...
//             initEvents(enable);
//             initDraw(enable);
//             circleCursorActionRef.current?.setEnable(enable);
//             if (enable) {
//                 circleCursorActionRef.current?.setRadius(widthRef.current.width / 2);
//             }
//         },
//         [initEvents, initDraw],
//     );
...
//                 onChange={(value) => {
//                     enableStraightLineRef.current = value;
//                     refreshMouseMove();
//                 }}
//                 toolbarLocation="highlight"
//             />
...
// export const HighlightTool = withBaseTool(HighlightToolCore, DrawState.Highlight);
